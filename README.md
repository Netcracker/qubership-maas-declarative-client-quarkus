[![Maven build](https://github.com/Netcracker/qubership-maas-declarative-client-quarkus/actions/workflows/maven-deploy.yml/badge.svg)](https://github.com/Netcracker/qubership-maas-declarative-client-quarkus/actions/workflows/maven-deploy.yml)
...
| maas.kafka.client.producer.[your-producer-name].topic.template                                        | String  | false     |               | The [template](https://github.com/Netcracker/qubership-maas/blob/main/README.md#kafka-templates-lazy-topics-tenant-topics) of maas topic                                                                                                                                                                                                                                                                                                                                                                       |
...
| maas.kafka.client.consumer.[your-consumer-name].topic.template                                        | String  | false     |               | The [template](https://github.com/Netcracker/qubership-maas/blob/main/README.md#kafka-templates-lazy-topics-tenant-topics) of maas topic                                                                                                                                                                                                                                                                                                                                                                       |
...
```
See documentation of [blue-green-state-monitor-quarkus](https://github.com/Netcracker/qubership-core-blue-green-state-monitor-quarkus/blob/main/README.md)
